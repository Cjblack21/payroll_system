...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO registration (deduction, salary) VALUES ('$deduction', '$salary')";
...
if(isset($_POST['update'])){
    ...
    $update_sql = "UPDATE registration SET deduction = '$deduction', salary = '$salary' WHERE id=$id";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="EDITSALARY.css">
</head>
<body>
    <nav class="sidebar">
        <h1>Payroll M S</h1>
        ...
        <div class="container">
            <div class="form-container">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <h2><?php echo isset($_GET['edit']) ? 'Edit Salary': ''; ?></h2>
                    <p>Deduction:</p> 
    ...
    <script>
        // Calculate total dynamically when deduction field changes
